  ...
  function generate(){
    var quotes = [
	'If you want to achieve greatness stop asking and for permission. - Anonymous',
    ...
    quoteAuthor=randomQuote.split("-");
		quote = $('.quote').text(quoteAuthor[0]);
		author = $('.author').text(quoteAuthor[1]);
}
   
 $('#tweetBtn').on('click', function(){    window.open('https://twitter.com/intent/tweet?text='+ randomQuote + ' | A CoDePen by LindaKovacs 2017', 'Share', 'width=700, height=500, toolbar=0, scrollbars=1, location=0, statusbar=0, menubar=0, resizable=1');
 });
